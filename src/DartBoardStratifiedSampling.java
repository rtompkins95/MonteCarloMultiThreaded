...
class DartBoardStratifiedSampling implements DartBoard {
    ...
    public DartBoardStratifiedSampling(int numThreads) {
    ...
    public double calculatePi() {
        ...
        double pi = 4.0 * (totalHits / totalThrows) / 10; // pi is off by a factor of 10 because we divided into 10 subregions
